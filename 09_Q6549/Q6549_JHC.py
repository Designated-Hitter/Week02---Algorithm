...
# hst = list(map(int, input().split()))[1:]
...
#     stack_right.append(hst[i])

#     while True:
#         if hst[i] > stack_left[-1]:
#             if hst[i] >= max_area[-1] + stack_left[-1]:
#                 max_area.append(hst[i])
#             else:
#                 max_area.append(max_area[-1] + stack_left[-1])
#         elif hst[i] <= stack_left[-1]:
